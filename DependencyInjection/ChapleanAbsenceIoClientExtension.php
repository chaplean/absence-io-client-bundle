 ...
 */
class ChapleanAbsenceIoClientExtension extends Extension
{
    /**
     * @param array            $configs
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('chaplean_absence_io_client', $config);
        $this->setParameters($container, 'chaplean_absence_io_client', $config);
    }
